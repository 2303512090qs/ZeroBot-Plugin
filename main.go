...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "西直门三太子", "Set default nickname.")
	...
	// 通过代码写死的方式添加主人账号
	// sus = append(sus, 2366401045)
	// sus = append(sus, 2303512090@qq.com)
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "ATRI", "atri", "上杉絵梨衣", "うえすぎ えりい"),
